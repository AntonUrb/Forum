...
// InsertUser inserts a new user entry into the Users table.
...
// GetUserPostLikes retrieves the likes of a post by a specific user.
...
// GetUserCommentLikes retrieves the likes of a comment by a specific user.
...
// GetUserDataStruct retrieves user data based on the username.
...
// GetUserLikedPosts retrieves posts that a user has liked.
...
// GetUserDislikedPosts retrieves posts that a user has disliked.
